 ...
 *****************************************************************
   ...
   BAND ( < 40M >, < 20M >, < , > ) OTHER has yet to be defined
   ...
   9(I.F.) + 7(40m) = 16 mhz.  9(I.F.) + 7.30 = 16.30 mhz.
   20 meters will use LO side injection.
   14(20m) - 9(I.F.) = 5 mhz.  14.35(20m) - 9(I.F.) = 5.35 mhz.
...
const char txt110[5]        = "VOPK"; // F_Zia 2021_0619 Replaced BATT with VOPK
...
//-----------------------------------------------------
const long meter_40             = 16.285e6; 
// Band frequency + IF, default for 40
// HI  side injection 40 meter
// range 16 > 16.3 mhz
const long meter_20             = 5.285e6;  
// F_Zia, changed 20m startup freq to FT8 freq
// const long meter_20             = 5.074e6;  // Band frequency - IF, default for 20
// Band frequency - IF, default for 20
